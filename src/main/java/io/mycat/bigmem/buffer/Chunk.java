...
/**
*
*or zhangwy   : 2016年12月28日 上午6:51:16
**/
public class Chunk<T> {
    ...
    public Chunk(Arena<T> arena, T memory, int chunkSize, int pageSize, int maxOrder) {
        pooled = true;
        this.arena = arena;
        this.memory = memory;
    ...
    *  如果是大于pageSize的，则直接释放当前的memoryId，同时增加freeBytes
    ...
    public String toString() {
        return new StringBuilder().append("Chunk(").append(Integer.toHexString(System.identityHashCode(this)))
                .append(": ").append(usage()).append("%, ").append(chunkSize - freeBytes).append('/').append(chunkSize)
                .append(')').toString();
    }
    ...
    public static void main(String[] args) {
        ...
        // new Arena<DirectBuffer>(),
        // (DirectBuffer)ByteBuffer.allocateDirect(chunkSize) ,chunkSize,
        // pageSize,maxOrder);
